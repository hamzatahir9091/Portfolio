		...
		<div ref={skillsContainer} id="skills" className="">
			<div className="mainContent  font-clashDisplay  w-screen min-h-screen flex flex-col gap-[5.71vw] justify-center ">
				<div className="big-wrap flex justify-center  w-screen">
					<div className="bigSkill  leading-0 text-[35vw] mt-0 mb-[15.24vw] font-extrabold text-[var(--text)] "><h1>Skills</h1></div>
				</div>

				<div className="pined  ">
					<div className="animater relative flex flex-col min-h-screen min-w-screen ">
						<div id="frontPanel" className="panel  relative    min-h-screen min-w-screen flex items-center justify-center">
								...
								{/* The transparent rect is removed as the background is typically handled by the container */}<g transform="matrix(5.94 0 0 5.94 250 250)">
									<g>
										...
										<g transform="matrix(1 0 0 1 30.49 0.05)" id="path_3">
											...
											/>
										</g></g></g></svg><span className="absolute top-1/3 left-1/2 bg-[#a3ffe0] border-[var(--border)] text-[var(--bgColor)] font-medium rounded-xl p-2 border  transform -translate-x-1/2 opacity-0">GSAP</span></div>
							<div id="threejs" className="frontLogo logo pointer-events-none   absolute top-[70%] left-[20%] ">
								<svg aria-hidden="true" width={"6vw"}
									version="1.1"
									id="Layer_1"
									x="0px"
									y="0px"
						...
						<div id="backPanel" className="panel relative  min-h-screen  min-w-screen flex items-center justify-center">
							...
							</svg><span className="absolute top-1/3 left-1/2 bg-[#a3ffe0] border-[var(--border)] text-[var(--bgColor)] font-medium rounded-xl p-2 border  transform -translate-x-1/2 opacity-0">MongoDB</span>
							</div>
							<div id="ts" className="backLogo logo pointer-events-none   absolute top-[72%] left-[74%] ">
								<svg aria-hidden="true" fill="none" height="6vw" viewBox="0 0 256 256" width="256" xmlns="http://www.w3.org/2000/svg"><rect fill="#ffffff" height="256" rx="20" width="256" /><path clipRule="evenodd" d="m150.518 200.475v27.62c4.492 2.302 9.805 4.028 15.938 5.179s12.597 1.726 19.393 1.726c6.622 0 12.914-.633 18.874-1.899s11.187-3.352 15.678-6.257c4.492-2.906 8.048-6.704 10.669-11.394 2.62-4.689 3.93-10.486 3.93-17.391 0-5.006-.749-9.394-2.246-13.163s-3.657-7.121-6.479-10.055c-2.821-2.935-6.205-5.567-10.149-7.898-3.945-2.33-8.394-4.531-13.347-6.602-3.628-1.497-6.881-2.949-9.761-4.359-2.879-1.41-5.327-2.848-7.342-4.316-2.016-1.467-3.571-3.021-4.665-4.661s-1.641-3.495-1.641-5.567c0-1.899.489-3.61 1.468-5.135s2.362-2.834 4.147-3.927c1.785-1.094 3.973-1.942 6.565-2.547 2.591-.604 5.471-.906 8.638-.906 2.304 0 4.737.173 7.299.518 2.563.345 5.14.877 7.732 1.597 2.591.719 5.11 1.625 7.558 2.719 2.447 1.093 4.708 2.359 6.781 3.797v-25.807c-4.204-1.611-8.797-2.805-13.778-3.582s-10.697-1.165-17.147-1.165c-6.565 0-12.784.705-18.658 2.115-5.874 1.409-11.043 3.61-15.506 6.602-4.463 2.993-7.99 6.805-10.582 11.437-2.591 4.632-3.887 10.17-3.887 16.615 0 8.228 2.375 15.248 7.127 21.06 4.751 5.811 11.963 10.731 21.638 14.759 3.801 1.554 7.343 3.078 10.625 4.575 3.283 1.496 6.119 3.049 8.509 4.66s4.276 3.366 5.658 5.265 2.073 4.057 2.073 6.474c0 1.783-.432 3.438-1.296 4.963-.863 1.524-2.174 2.848-3.93 3.97s-3.945 1.999-6.565 2.632-5.687.95-9.2.95c-5.989 0-11.92-1.05-17.794-3.151-5.875-2.1-11.317-5.25-16.327-9.451zm-46.036-68.733h35.518v-22.742h-99v22.742h35.3447v101.258h28.1373z" fill="var(--bgColor)" fillRule="evenodd" /></svg><span className="absolute top-1/3 left-1/2 bg-[#a3ffe0] border-[var(--border)] text-[var(--bgColor)] font-medium rounded-xl p-2 border  transform -translate-x-1/2 opacity-0">Typescript</span>
							</div>

						</div>


						<div id="toolPanel" className="panel relative  min-h-screen  min-w-screen flex items-center justify-center">
							...
							<div id="figma" className="toolLogo logo pointer-events-none   absolute top-[35%] left-[82%] "><svg aria-hidden="true" width="6vw" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
								<path
									...
									fill="#ffffff"
								/>
							</svg><span className="absolute top-1/3 left-1/2 bg-[#a3ffe0] border-[var(--border)] text-[var(--bgColor)] font-medium rounded-xl p-2 border  transform -translate-x-1/2 opacity-0">Figma</span></div>
							<div id="github" className="toolLogo logo pointer-events-none   absolute top-[72%] left-[74%] ">
								<svg aria-hidden="true" width={"6vw"} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="#ffffff"><path d="M12.001 2C6.47598 2 2.00098 6.475 2.00098 12C2.00098 16.425 4.86348 20.1625 8.83848 21.4875C9.33848 21.575 9.52598 21.275 9.52598 21.0125C9.52598 20.775 9.51348 19.9875 9.51348 19.15C7.00098 19.6125 6.35098 18.5375 6.15098 17.975C6.03848 17.6875 5.55098 16.8 5.12598 16.5625C4.77598 16.375 4.27598 15.9125 5.11348 15.9C5.90098 15.8875 6.46348 16.625 6.65098 16.925C7.55098 18.4375 8.98848 18.0125 9.56348 17.75C9.65098 17.1 9.91348 16.6625 10.201 16.4125C7.97598 16.1625 5.65098 15.3 5.65098 11.475C5.65098 10.3875 6.03848 9.4875 6.67598 8.7875C6.57598 8.5375 6.22598 7.5125 6.77598 6.1375C6.77598 6.1375 7.61348 5.875 9.52598 7.1625C10.326 6.9375 11.176 6.825 12.026 6.825C12.876 6.825 13.726 6.9375 14.526 7.1625C16.4385 5.8625 17.276 6.1375 17.276 6.1375C17.826 7.5125 17.476 8.5375 17.376 8.7875C18.0135 9.4875 18.401 10.375 18.401 11.475C18.401 15.3125 16.0635 16.1625 13.8385 16.4125C14.201 16.725 14.5135 17.325 14.5135 18.2625C14.5135 19.6 14.501 20.675 14.501 21.0125C14.501 21.275 14.6885 21.5875 15.1885 21.4875C19.259 20.1133 21.9999 16.2963 22.001 12C22.001 6.475 17.526 2 12.001 2Z"></path></svg><span className="absolute top-1/3 left-1/2 bg-[#a3ffe0] border-[var(--border)] text-[var(--bgColor)] font-medium rounded-xl p-2 border  transform -translate-x-1/2 opacity-0">Github</span>
							</div>
