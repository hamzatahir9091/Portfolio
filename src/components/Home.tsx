				...
				<div id="homeInside"
					...
					<div className="  mainContent font-clashDisplay min-w-screen flex flex-row justify-center items-center ">
						<div className="relative  home-text text-[var(--text)]  w-1/2 h-screen flex flex-col justify-center items-center  ">
							<div className="mainText text-[4vw] flex gap-[0.71vw] justify-center items-baseline">
								...
								<span className="firstline">
									<span><h1>Hello, I'm</h1></span>
								</span>
								<span className="name text-[6.5vw] text-[var(--text)]  font-extrabold inline-block">
									HAMZA
								</span>
						...
						<div
							...
							<div ref={imgRef} className="imgWrapper bg-[#015A4E] p-[1.67vw] rounded-[5vw] ">
								<img
							...
							{/* === Abstract Shape SVG === */}
							<svg id="arrow" className="absolute top-[24%] left-[-6%] transform -rotate-90" width={"10vw"} version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 158 192" fill="none" stroke="#ffffff" preserveAspectRatio="xMidYMid meet" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:svgjs="http://svgjs.dev/svgjs">
