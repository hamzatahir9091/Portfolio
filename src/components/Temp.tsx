...
const Temp = () => {
  ...
  useGSAP(() => {
    ...
    const icon = gsap.utils.toArray<HTMLElement>(".logo")
    ...
    icon.forEach((icone, i) => {
      const text = icone.querySelector("span"); // your skill name


      icone.addEventListener("mouseenter", () => {
        gsap.to(icone, { scale: 1.1, duration: 0.3, opacity: 0.5 })
        gsap.to(text, { opacity: 1, scale: 1.1, y: 0, duration: 0.3 }); // show skill
      }

      )
      icone.addEventListener("mouseleave", () => {
        gsap.to(icone, { scale: 1, duration: 0.3, opacity: 1 })
  ...
  return (
    <>
      <div className="animater absolute flex flex-col z-10 w-screen h-screen  ">
